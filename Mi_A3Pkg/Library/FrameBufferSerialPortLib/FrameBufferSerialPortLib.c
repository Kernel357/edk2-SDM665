...
//	ResetFb();
	...
	ResetFbHeader();
	ResetFbFooter();
	UpdateHeader(L"EDK2 Mi A3 by Kernel",1);
	m_Initialized = TRUE;
...
void ResetFbHeader(void)
{
	...
	UINTN hBgColor = FB_BGRA8888_RED;
...
void ResetFbFooter(void)
{
	...
	UINTN fBgColor = FB_BGRA8888_RED;
